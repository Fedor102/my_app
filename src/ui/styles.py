...
class AppStyles:
    ...
    MESSAGE_INPUT = {
        ...
        "text_size": 10,                     # Размер шрифта текста
        ...
        "hint_text": "Введите сообщение здесь для общения с ИИ...",  # Текст-подсказка в пустом поле
    ...
    # Настройки кнопки отправки в telegram
    TELEGRAM_BUTTON = {
        "text": "Отправлять уведомление в telegram",                  # Текст на кнопке
        "icon": ft.icons.EMAIL,             # Иконка удаления
        "style": ft.ButtonStyle(             # Стиль оформления кнопки
            color=ft.Colors.WHITE,           # Цвет текста
            bgcolor=ft.Colors.BLUE_700,       # Красный цвет фона для предупреждения
            padding=10,                      # Внутренние отступы
        ),
        "tooltip": "Очистить историю чата",   # Всплывающая подсказка
    ...
    # Настройки кнопки отправки на почту
    EMAIL_BUTTON = {
        "text": "Отправлять уведомление на почту",                  # Текст на кнопке
        "icon": ft.icons.EMAIL,             # Иконка удаления
        "style": ft.ButtonStyle(             # Стиль оформления кнопки
            color=ft.Colors.WHITE,           # Цвет текста
            bgcolor=ft.Colors.WHITE10,       # Красный цвет фона для предупреждени
            padding=10,                      # Внутренние отступы
        ),
        "tooltip": "Очистить историю чата",   # Всплывающая подсказка
        "width": 250,                        # Ширина кнопки
    ...
    # Настройки строки с кнопками уведомлений о балансе 
    BALANCE_BUTTONS_ROW = {
    ...
    CONTROLS_COLUMN = {
        "spacing": 1,                                    # Отступ между элементами
    ...
    def set_window_size(page: ft.Page):
        ...
        page.window.resizable = True        # Запрет изменения размера пользователем