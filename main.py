...
sys.path.append(os.path.join(os.path.dirname(__file__), "src"))  # Добавляет src в PYTHONPATH
...
from src.ui.components import MessageBubble, ModelSelector  # Компоненты пользовательского интерфейса
